function PromptManager(gameController, tileEngine) {
	...
	this.showKeysAndLetters = function() {
			...
			if(tileEngine.canMoveLeft(this.tileEngine.player)) {
				...
				if(this.tileEngine.objectToLeft()) {
					$("#leftKey").css("opacity",this.keyOpacity);
					$("#leftLetter").css("opacity",this.keyOpacity);
				}
				else {
					$("#leftKey").css("opacity",1);
					$("#leftLetter").css("opacity",1);				
				}
			}
			else {
				$("#leftKey").hide();
			...
			if(tileEngine.canMoveRight(this.tileEngine.player)) {
				...
				if(this.tileEngine.objectToRight()) {
					$("#rightKey").css("opacity",this.keyOpacity);
					$("#rightLetter").css("opacity",this.keyOpacity);
				}
				else {
					$("#rightKey").css("opacity",1);
					$("#rightLetter").css("opacity",1);				
				}
			}
			else {
				$("#rightKey").hide();
			...
			if(tileEngine.canMoveUp(this.tileEngine.player)) {
				...
				if(this.tileEngine.objectToUp()) {
					$("#upKey").css("opacity",this.keyOpacity);
					$("#upLetter").css("opacity",this.keyOpacity);
				}
				else {
					$("#upKey").css("opacity",1);
					$("#upLetter").css("opacity",1);				
				}
			}
			else {
				$("#upKey").hide();
			...
			if(tileEngine.canMoveDown(this.tileEngine.player)) {
				...
				if(this.tileEngine.objectToDown()) {
					$("#downKey").css("opacity",this.keyOpacity);
					$("#downLetter").css("opacity",this.keyOpacity);
				}
				else {
					$("#downKey").css("opacity",1);
					$("#downLetter").css("opacity",1);				
				}
			}
			else {
				$("#downKey").hide();
